...
#define BOOTENV_SHARED_UFS \
	"sunxi_flash_ufs_boot=" \
		"sunxi_flash init ufs; " \
		BOOTENV_SHARED_BLKDEV_BODY(sunxi_flash_ufs)
#define BOOTENV_DEV_UFS		BOOTENV_DEV_BLKDEV
#define BOOTENV_DEV_NAME_UFS	BOOTENV_DEV_NAME_BLKDEV
#else
#define BOOTENV_RUN_NET_UFS_START
#define BOOTENV_SHARED_UFS
#define BOOTENV_DEV_UFS \
	BOOT_TARGET_DEVICES_references_UFS_without_CONFIG_SUNXI_UFS
#define BOOTENV_DEV_NAME_UFS \
	BOOT_TARGET_DEVICES_references_UFS_without_CONFIG_SUNXI_UFS
#endif
